...
<body>
    ...
    <div class="container">
        ...
        <div class="section">   
            <h5 style="color: blue; font-weight: bold; margin-left: 2rem;">USER DETAILS</h5> 
             
             <div style="margin-top:3rem">
            <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">                
                <a class="navbar-brand" href="#" style="color: black; font-weight: bold;">Full Name</a> 
                <a class="navbar-brand" href="#" style="color: black; font-weight: bold;">Email</a> 
                <a class="navbar-brand" href="#" style="color: black; font-weight: bold;">Mobile</a> 
                <a class="navbar-brand" href="#" style="color: black; font-weight: bold;">NIC</a>                             
            </div>            
            </nav>
            <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">                
                <a class="navbar-brand" href="#" style="color: black;">Check</a> 
                <a class="navbar-brand" href="#" style="color: black;">check1@gmail.com</a> 
                <a class="navbar-brand" href="#" style="color: black;">0763568966</a> 
                <a class="navbar-brand" href="#" style="color: black;">543267895V</a>                             
            </div>            
            </nav>   
            </div> 
